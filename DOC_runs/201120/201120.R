...
setwd("/Users/phill/Dropbox/Isotopes/sugarIsotopes/201120")

dat <- read_csv("13CAdditionData_CrestonLeachate_20190809(1).csv")
picarro <- read_csv("CFIDS2157_IsotopicData_20201120_210617.csv")
aurora <- read_csv("Hall_201120.csv")
