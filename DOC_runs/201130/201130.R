...
setwd("/Users/phill/Dropbox/Isotopes/sugarIsotopes/201130")

dat <- read_csv("13CAdditionData_SideChannelGlucose_20190812_analyzed.csv")
picarro <- read_csv("CFIDS2157_IsotopicData_20201130_193011.csv")
aurora <- read_csv("Hall_201130.csv")
...
write.csv(dat, file="13CAdditionData_SideChannelGlucose_20190812_analyzed.csv")
