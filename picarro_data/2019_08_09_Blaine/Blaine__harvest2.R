...
setwd("/Users/bobhall/Dropbox/Picarro/Picarro raw data files/2019_08_09_Blaine/")
...
meta <- read.table("2019_08_09_Blaine.txt", sep=",",header=T)
...
## Export
###########
write.csv(sum_file, "2019_08_08_Blaine.csv")
