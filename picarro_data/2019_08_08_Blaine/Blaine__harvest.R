...
setwd("/Users/bobhall/Dropbox/Picarro/Picarro raw data files/2019_08_08_Blaine/")
...
meta <- read.table("2019_08_08_Blaine.txt", sep=",",header=T)
...
## Export
###########
write.csv(sum_file, "2019_08_06_Nyackwell.csv")
...
downblaine<-read_csv("blaine_field.csv")


down<-left_join(downblaine, sum_file, by="Syringe")


plot(down$time,down$delCO2)

L<-3.5*120*60

80/25200

(2*0.0108+0.00317)/2.003
